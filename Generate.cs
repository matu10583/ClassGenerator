...
namespace ClassGenerator
{
    ...
    internal sealed class Generate
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("e7f13fbc-5d0b-4152-90f2-c4b654e8cf09");
        ...
        {
            // Switch to the main thread - the call to AddCommand in Generate's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var form = new GeneratorForm(this.package as ClassGeneratorPackage);
            form.ShowDialog();
        }
    }
}
